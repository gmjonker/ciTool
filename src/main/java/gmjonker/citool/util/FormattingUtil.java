...
import static gmjonker.citool.math.GeneralMath.min;
import static gmjonker.citool.math.GeneralMath.round;
import static gmjonker.citool.math.NaType.isValue;
import static java.util.concurrent.TimeUnit.*;

public class FormattingUtil
{
    private static final LambdaLogger log = new LambdaLogger(FormattingUtil.class);
