...
import static gmjonker.citool.math.GeneralMath.max;
import static gmjonker.citool.math.NaType.getValueOr;
import static gmjonker.citool.math.NaType.isValue;

public class CollectionsUtil
{
    private static final LambdaLogger log = new LambdaLogger(CollectionsUtil.class);
